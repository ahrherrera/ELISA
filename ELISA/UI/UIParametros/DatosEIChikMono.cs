...
{
    public partial class DatosEIChikMono : Form
    {
        List<CheckBox> listaCheck = new List<CheckBox>();
        public DatosEIChikMono()
        {
            InitializeComponent();
        }
        ...
        private void fillFields()
        {
            ...
            datosprotocolochikmono data = DatosProtocoloEIChikMono.TraerDatosProtocoloChikMono();
        ...
        private void btn_Aceptar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                datosprotocolochikmono nuevo = new datosprotocolochikmono();
                ...
                DatosProtocoloEIChikMono.updateProtocoloChikMono(nuevo);
                if (allchecked)
                {
