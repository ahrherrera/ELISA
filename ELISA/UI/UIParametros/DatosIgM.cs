...
namespace ELISA.UI.UIParametros
{
    public partial class DatosIgM : Form
    {
        ...
        {
            DialogResult res = new Controles(MainUtils.Controles.ControlesIgM_CPA, this).ShowDialog(this);
        }

        private void txt_ControlPosBajo_Click(object sender, EventArgs e)
        {
            DialogResult res = new Controles(MainUtils.Controles.ControlesIgM_CPB, this).ShowDialog(this);
        }

        private void txt_ControlNeg_Click(object sender, EventArgs e)
        {
            DialogResult res = new Controles(MainUtils.Controles.ControlesIgM_C, this).ShowDialog(this);
        }

        private void txt_ControlPosRadio_Click(object sender, EventArgs e)
        {
            DialogResult res = new Controles(MainUtils.Controles.ControlesIgM_CRP, this).ShowDialog(this);
        }

        private void txt_ControlNegRadio_Click(object sender, EventArgs e)
        {
            DialogResult res = new Controles(MainUtils.Controles.ControlesIgM_CRN, this).ShowDialog(this);
        }
    }
}
