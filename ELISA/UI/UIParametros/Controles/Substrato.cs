...
{
    public partial class Substrato : Form
    {
        ...
        {
            SubstratoTrans.getSubs(dgv_Controles);
            ...
            dgv_Controles.Columns[0].HeaderText = "Lote Asignado TMB";
            dgv_Controles.Columns[1].HeaderText = "Lote";
            dgv_Controles.Columns[2].HeaderText = "Distribuidora";
            dgv_Controles.Columns[3].HeaderText = "Cod Catalogo TMB";
        ...
        private void btn_Agregar_Click(object sender, EventArgs e)
        {
            ...
            NuevoSubstrato nuevoSubs = new NuevoSubstrato();
            DialogResult res = nuevoSubs.ShowDialog(this);
        ...
        private void btn_Eliminar_Click(object sender, EventArgs e)
        {
            if (dgv_Controles.SelectedRows.Count > 0)
            {
                ...
                if (res == DialogResult.Yes)
                {
                    ...
                    SubstratoTrans.removeSubs(CodigoControl);
                    switchParam();
                }
            }
        }
