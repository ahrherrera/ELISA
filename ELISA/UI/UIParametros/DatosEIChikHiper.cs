...
{
    public partial class DatosEIChikHiper : Form
    {
        List<CheckBox> listaCheck = new List<CheckBox>();
        public DatosEIChikHiper()
        {
            InitializeComponent();
        }
        ...
        private void fillFields()
        {
            ...
            datosprotocolochikhiper data = DatosProtocoloChikHiper.TraerDatosProtocoloChikHiper();
        ...
        private void btn_Aceptar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                datosprotocolochikhiper nuevo = new datosprotocolochikhiper();
                ...
                DatosProtocoloChikHiper.updateProtocoloChikMono(nuevo);
                if (allchecked)
                {
        ...
        private void txt_LoteAsignado_DoubleClick(object sender, EventArgs e)
        {
            DialogResult res = new Gamma(this.txt_LoteAsignado).ShowDialog(this);
        }

        private void txt_PB_DoubleClick(object sender, EventArgs e)
        {
            DialogResult res = new PB(this.txt_PB).ShowDialog(this);
        }
    }
}
