...
{
    public partial class DatosIgG : Form
    {
        ...
        private void addList()
        {
            ...
            listaCheck.Add(chk_ControlNegSal);
        ...
        private void Check(bool stat)
        {
            ...
            chk_ControlNegSal.Checked = stat;
        ...
        {
            DialogResult res = new ControlesIgG(MainUtils.Controles.ControlesIgG_CP, this).ShowDialog(this);
        }

        private void txt_ControlNeg_Click(object sender, EventArgs e)
        {
            DialogResult res = new ControlesIgG(MainUtils.Controles.ControlesIgG_CN, this).ShowDialog(this);
        }

        private void txt_ControlNegSal_Click(object sender, EventArgs e)
        {
            DialogResult res = new ControlesIgG(MainUtils.Controles.ControlesIgG_CNS, this).ShowDialog(this);
        }
